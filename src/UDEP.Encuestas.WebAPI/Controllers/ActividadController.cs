...
namespace UDEP.Encuestas.WebAPI.Controllers
{
    ...
    public class ActividadController : ControllerBase
    {
        ...
        public ActividadController(ActividadService service, ILogger<ActividadController> logger)
        {
            _service = service;
            _logger = logger;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Post(Actividad entity)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Put(Actividad entity)
        {
            var user = User.Identity?.Name ?? "anonymous";
