...
namespace UDEP.Encuestas.WebAPI.Controllers
{
    ...
    public class ComponenteController : ControllerBase
    {
        ...
        public ComponenteController(ComponenteService service, ILogger<ComponenteController> logger)
        {
            _service = service;
            _logger = logger;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Post(Componente entity)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Put(Componente entity)
        {
            var user = User.Identity?.Name ?? "anonymous";
