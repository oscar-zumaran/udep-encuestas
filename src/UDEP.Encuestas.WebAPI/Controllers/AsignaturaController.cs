...
namespace UDEP.Encuestas.WebAPI.Controllers
{
    ...
    public class AsignaturaController : ControllerBase
    {
        ...
        public AsignaturaController(AsignaturaService service, ILogger<AsignaturaController> logger)
        {
            _service = service;
            _logger = logger;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Post(Asignatura entity)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Put(Asignatura entity)
        {
            var user = User.Identity?.Name ?? "anonymous";
