...
{
    /// <summary>
    /// Entidad que representa la tabla Instruccion_Pregunta_Encuesta.
    /// </summary>
    public class Instruccion_Pregunta_Encuesta
    {
        public int iIdInstruccionPreguntaEncuesta { get; set; }
        public int iIdEncuesta { get; set; }
        public int iIdPreguntaEncuesta { get; set; }
        public int iIdPregunta { get; set; }
        public int iIdInstruccionPregunta { get; set; }
